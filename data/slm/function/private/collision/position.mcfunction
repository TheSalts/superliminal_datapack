...
$execute as @e[tag=collision,tag=!small,limit=8,sort=nearest,type=block_display] on passengers as @s[type=shulker] run attribute @s scale base set $(scale_half)
