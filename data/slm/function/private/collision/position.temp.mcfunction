...
$execute as @e[tag=temp_collision,tag=!small,limit=8,sort=nearest,type=block_display] on passengers as @s[type=shulker] run attribute @s generic.scale base set $(scale_half)
