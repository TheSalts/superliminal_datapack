...
$execute as @e[tag=collision,tag=small,tag=temp_collision,type=block_display] on passengers as @s[type=shulker,tag=collision_shulker] run attribute @s generic.scale base set $(scale)
