...
execute unless entity @e[tag=temp_collision,type=block_display] run tag @e[tag=collision,tag=small,limit=1,sort=nearest,type=block_display] add temp_collision
