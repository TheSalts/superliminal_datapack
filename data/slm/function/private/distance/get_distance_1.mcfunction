...
execute as @e[tag=targetW,tag=small.target,type=block_display] at @s as @n[tag=collision,tag=small,type=block_display] at @s run function slm:private/interaction/kill_shulker
