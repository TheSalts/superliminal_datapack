function slm:private/var/original_target_scale
execute as @e[tag=targetW,type=block_display] at @s run function slm:_internal/private/distance/_get_distance_3
