...
## 중력가속도
    execute if score @s hitbox.gravity matches 0 run function slm:_internal/private.gravity.gravity.1
...
execute if score $adjust hitbox.gravity matches 1 if score @s hitbox.gravity matches 1 run function slm:_internal/private.gravity.gravity.2
