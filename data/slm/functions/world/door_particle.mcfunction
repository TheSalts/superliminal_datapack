...
execute as @e[tag=door_block_interaction] at @s if block ~ ~ ~ structure_void run tag @s add block
execute as @e[tag=door_block_interaction] at @s unless block ~ ~ ~ structure_void run tag @s remove block