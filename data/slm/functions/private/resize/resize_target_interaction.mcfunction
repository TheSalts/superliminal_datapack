...
execute as @e[tag=targetInteraction,type=interaction] at @s store result entity @s width float 0.00001 run data get entity @e[tag=target,limit=1,sort=nearest,type=block_display] transformation.scale[0] 110000
